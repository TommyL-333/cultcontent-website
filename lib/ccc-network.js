...
function updateProfile(id, { first_name, last_name, phone, brand_name, tiktok_handle, instagram_handle, category, bio, links, looking_for, photo_url, rate_videos, rate_price, rate_terms, booth_zone }) {
  db.prepare(`
    UPDATE ccc_people SET
      ...
      rate_videos = ?, rate_price = ?, rate_terms = ?, booth_zone = ?
    WHERE id = ?
