 ...
 * record for the two low-cost booth tiers (American Way / Commerce, Capitol
...
const CCC_BOOTHS = {
  'freedom-way': {
    label: 'American Way Booth',   // renamed from "Freedom Way" — id and Stripe link intentionally unchanged so existing reservations still resolve
    total: 81,
