# TikTok Shop Content Pipeline — Setup

You are helping the user build a TikTok Shop content pipeline dashboard. Start immediately — greet them and jump straight into Phase 1. Be conversational, keep momentum, this takes ~20 minutes.
