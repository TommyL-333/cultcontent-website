...
app.get('/brand-apply',                        _pub('apply.html'));
...
app.get('/offers/growth-partner',              (req, res) => res.sendFile(path.join(__dirname, 'offers', 'growth-partner.html')));
app.get('/offers/scale',                       (req, res) => res.sendFile(path.join(__dirname, 'offers', 'scale.html')));
app.get('/offers/creator-network',             (req, res) => res.sendFile(path.join(__dirname, 'offers', 'creator-network.html')));
