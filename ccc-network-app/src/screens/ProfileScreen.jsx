  ...
  return (
    <div>
      ...
      <div className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <p className="text-sm text-zinc-400 mb-7">This is what the rest of the roster sees once you&rsquo;re connected. Edit it any time in Settings.</p>
        ...
        <Card variant="default" className="p-6 sm:p-7 mt-5 text-center">
          <div className="text-xs font-bold uppercase tracking-wide text-zinc-500 mb-3">Meet in person</div>
          {showQR ? (
            <div className="flex flex-col items-center gap-4">
              <div className="bg-white p-4 rounded-lg inline-block">
                <QRCodeSVG value={profileUrl} size={180} />
              </div>
              <p className="text-xs text-zinc-500 max-w-xs">Have someone scan this to pull up your profile and connect on the spot.</p>
